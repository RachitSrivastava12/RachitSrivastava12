...
|Portfolio| [Code](https://github.com/RachitSrivastava12/Todo-App) | ```MERN``` | [Preview] | NOVEMBER 23 |
|Customer Automation| .[Code](https://github.com/RachitSrivastava12/StellerSoroBAN) |```MERN``` ```RUST```| .[Preview] |MAY 24|
<br>
...
<img src="https://www.animatedimages.org/data/media/562/animated-line-image-0184.gif" width="1920" />
## 📊 GitHub Stats
| ![RACHIT github stats](https://github-readme-stats.vercel.app/api?username=RachitSrivastava12&show_icons=true&theme=radical) | ![Amit GitHub Streak](https://github-readme-streak-stats.herokuapp.com/?user=RachitSrivastava12&theme=highcontrast&hide_border=false)                                                                                                           |
| --------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
